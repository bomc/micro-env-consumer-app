...
import de.bomc.poc.consumer.application.validation.CustomPublishMetaDataValidator;
import de.bomc.poc.consumer.application.validation.ValidationFieldError;
...
public class CustomPublishMetaDataRequestHandler extends AbstractValidationHandler<PublishMetaData, CustomPublishMetaDataValidator> {
	 ...
	 */
	private CustomPublishMetaDataRequestHandler(final InMemoryPublishMetaDataService inMemoryPublishMetaDataService) {
    ...
    protected Mono<ServerResponse> processBody(final PublishMetaData publishMetaData, final ServerRequest serverRequest) {
		...
		return this.inMemoryPublishMetaDataService
				.update((PublishMetaData)publishMetaData)
